...
function hideInputPanel(e) {
    ...
    for (let i = 0; i < 4; i++) {
        if (targetElement === document.body)
            break;
        else if (targetElement.classList.contains("timer-input"))
            return;
        else if (targetElement.classList.contains("timer-set"))
            break;
        else if (!targetElement.parentElement.classList.contains("timer-input"))
